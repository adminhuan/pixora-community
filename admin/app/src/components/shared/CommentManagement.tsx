...
import { CommentTable, type CommentRow } from '../../pages/CommentAdmin/components/CommentTable';
...
const CommentManagement = ({ contentType, title = '评论管理' }: CommentManagementProps) => {
  ...
  const fetchComments = useCallback(async () => {
    ...
    try {
      const response = await adminCommentApi.comments({ targetType: contentType });
